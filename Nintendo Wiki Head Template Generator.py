...
while which != "simple" and which != "complex":
    print("----------\nIncorrect head template type.")
    which = input("Would you like a simple or complex head template?")
    which = which.lower()

#Print notice about entering variables
print("----------\nIf one or more of the following categories do not apply to the article, or if the answer to them is no, then simply press enter to skip them.\n----------")
